...
from rest_framework.permissions import IsAuthenticated #This is readonly if the user if not authenticated.
...
class UserProfilesFeedViewSet(viewsets.ModelViewSet):
    """Handle creating, reading and updating proile feed item"""
    ...
    # This function is for authenticated user_profile
